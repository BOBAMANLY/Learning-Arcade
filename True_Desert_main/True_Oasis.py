...
class InstructionsView(arcade.View):
    ...
    def on_show(self):
        ...
        self.cursor_sprite = arcade.Sprite("Learning-Arcade\True_Desert_main\Cursor.png", .5)
        ...
        for i in range(2):
            arrow_button = arcade.Sprite("Learning-Arcade\True_Desert_main\Arrow.png", .1)
...
class TrueOasis(arcade.View):
    ...
    def setup(self):
        ...
        for i in range(3):
            ...
            oasis = arcade.Sprite("Learning-Arcade\True_Desert_main\Oasis.png", .3)
            # Position the oasis
            ...
            # Create the button instance
            oasis_button = arcade.Sprite("Learning-Arcade\True_Desert_main\Button.png", .1)
